...
import 'package:eshop_multivendor/Screen/ProductDetail/Widget/productExtraDetail.dart';
...
class StateItem extends State<ProductDetail> with TickerProviderStateMixin {
      ...
      try {
        ...
        ApiBaseHelper().postAPICall(getCartApi, parameter).then((getdata) {
          ...
          if (!error) {
            ...
            Map abc = {};
            print("promo code get data : ${getdata}");
            ...
            if (getdata.containsKey(PROMO_CODES)) {
              ...
              print("promo code12: ${context.read<CartProvider>().promoList.length}");
            }
          } else {}
          if (mounted) {
            setState(() {});
  ...
  final List<TextEditingController> controllerTextNew = [];
  ...
  _showContent() {
    return Column(
      ...
      children: <Widget>[
                          ...
                          Column(
                            ...
                            children: [
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    available! || outOfStock!
                                        ?(CUR_USERID != null)?GetPrice(
                                            pos: selectIndex,
                                            from: true,
                                            model: widget.model):InkWell(
                                      onTap: () {
                              ...
                              widget.model!.attributeList!.isNotEmpty
                                  ? getDivider(2, context)
                                  : const SizedBox(),
                              (CUR_USERID == null)?SizedBox():getvariantPart(),
                              getDivider(2, context),
        ...
        ((widget.model?.prVarientList?.length ?? 0) == 1)
            ? widget.model!.attributeList!.isEmpty
                ? widget.model!.availability != '0'
                    ? (CUR_USERID == null)?SizedBox():Container(
                        decoration: BoxDecoration(
                          color: Theme.of(context).colorScheme.white,
                          boxShadow: [
                            BoxShadow(
  ...
  faqsQuesAndAns() {
    return context.read<ProductDetailProvider>().faqsProductList.isNotEmpty
        ? Padding(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                Column(
                                  children:
                                      List.generate(chips.length, (indexAT) {
                                    if (controllerTextNew.length <
                                        indexAT + 1) {
                                      controllerTextNew
                                    ...
                                    controllerTextNew[indexAT].text = widget
                                        .model!
                                        .prVarientList![indexAT]
                                        .cartCount!;
                                    return Padding(
                                      padding: const EdgeInsets.only(
                                        bottom: 15,
                                          ...
                                          Row(
                                            children: <Widget>[
                                              widget.model!.type ==
                                                  ...
                                                  : InkWell(
                                                      ...
                                                      onTap: () async {
                                                        ...
                                                        log("REMOVE");
                                                        log("QUANTITY REMOV===${widget.model!.prVarientList![indexAT].quantity}");
                                              ...
                                              widget.model!.type ==
                                                  ...
                                                  //           if (isProgress ==
                                                  //               false) {
                                                  //             log("VIJAY STEP SIZE===${ widget.model!.qtyStepSize.toString()}");
                                                  //             // addCart(widget.index!, widget.model!.qtyStepSize.toString(), 2);
                                                  //             // addToCart(
                                                  //             //   controllerTextNew[
                                                  //             //   indexAT].text,
                                                  //             //   true,
                                                  ...
                                                  : Padding(
                                                      ...
                                                      child: SizedBox(
                                                          width: 20,
                                                          child: Text(
                                                            '${widget.model!.prVarientList![indexAT].quantity}',
                                                            style:
                                                                const TextStyle(
                                                              fontFamily:
                                                                  'ubuntu',
