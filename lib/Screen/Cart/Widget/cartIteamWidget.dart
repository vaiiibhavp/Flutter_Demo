          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Text(
                  ' ${DesignConfiguration.getPriceFormat(context, (double.parse(cartList[index].singleItemNetAmount??"0")))!} x ${cartList[index].qty}',
                  style: TextStyle(
                    color: Theme.of(context).colorScheme.lightBlack2,
                    fontFamily: 'ubuntu',
                  ),
                ...
                Text(
                  ' ${DesignConfiguration.getPriceFormat(context, ((double.parse(cartList[index].singleItemNetAmount??"0")) * double.parse(cartList[index].qty!)))!}',
                  style: TextStyle(
                    color: Theme.of(context).colorScheme.lightBlack2,
                    fontFamily: 'ubuntu',
                  ),
            ...
            Row(
              ...
              children: [
                ...
                Text(
                  ' ${DesignConfiguration.getPriceFormat(context, ((double.parse(cartList[index].singleItemTaxAmount??"0")) * double.parse(cartList[index].qty!)))}',
                  style: TextStyle(
                    color: Theme.of(context).colorScheme.lightBlack2,
                    fontFamily: 'ubuntu',
                  ),
            ...
            Row(
              ...
              children: [
                ...
                Text(
                  DesignConfiguration.getPriceFormat(
                    context,
                    (((double.parse(cartList[index].singleItemNetAmount??"0")) *
                            double.parse(cartList[index].qty!)) +
                        (((double.parse(cartList[index].singleItemTaxAmount??"0")) *
                            double.parse(cartList[index].qty!)))),
                  )!,
                  style: TextStyle(
                    fontFamily: 'ubuntu',
