...
class _SearchState extends State<Explore> with TickerProviderStateMixin {
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      context.read<ExploreProvider>().isFilterAdd(false);
                      ...
                      () {
                        ...
                        if (mainlist.isNotEmpty) {
                          ...
                          items.addAll(mainlist
                              .map((data) => Product.fromJson(data)).toSet()
                              .toList());
              ...
              child: Column(
                ...
                children: [
                  ...
                  Consumer<HomePageProvider>(
                    builder: (contexts, categoryData, child) => Container(
                                ...
                                children: [
                                  Transform.scale(
                                    ...
                                    child: SizedBox(
                                      ...
                                      child: Checkbox(value: context.read<ExploreProvider>().selectedIndex==index?true:false, onChanged: (value) {
                                        context.read<ExploreProvider>().selectedFilter(index);
                                        context.read<ExploreProvider>().filterAdd(categoryData.catList[index].name.toString());
                                        context.read<ExploreProvider>().isFilterAdd(true);
                                        update();
