  ...
  _getDrawer() {
    return ListView(
      ...
      children: <Widget>[
        ...
        CUR_USERID == '' || CUR_USERID == null
            ? const SizedBox()
            : _getDrawerItem(getTranslated(context, 'Schemes & Discounts')!, 'promo'),
        CUR_USERID == '' || CUR_USERID == null
            ? const SizedBox()
            : _getDrawerItem(
                'Favorite', 'fav_black'),
  ...
  _getDrawerItem(String title, String img) {
    return Card(
      ...
      child: ListTile(
        ...
        leading: title == getTranslated(context, 'Schemes & Discounts')
            ? Image.asset(
        ...
        onTap: () {
          ...
          } else if (title == getTranslated(context, 'Schemes & Discounts')) {
