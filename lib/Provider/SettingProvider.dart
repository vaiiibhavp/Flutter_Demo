...
class SettingProvider {
  ...
  void setDashboard(String key, bool value) async {
    _sharedPreferences.setBool(key, value);
  }

  Future<bool> getDashboard(String key) async {
    return _sharedPreferences.getBool(key) ?? false;
  }

  void setPassword(String key, String value) async {
    _sharedPreferences.setString(key, value);
  }
  ...
  Future<void> saveUserDetail(
    ...
    waitList
        .add(_sharedPreferences.setString(BUSINESS_NAME, businessName ?? ''));
    waitList.add(
        _sharedPreferences.setString(BUSINESS_ADDRESS, businessAddress ?? ''));
    ...
    userProvider.setBusinessName(businessName ?? '');
    userProvider.setBusinessAddress(businessAddress ?? '');
